...
namespace PowderCoatingWizard.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<PowderCoatingWizardWindowsFormsApplication>();
            builder.Modules
                .AddAuditTrailXpo()
                .AddCharts()
                .AddCloning()
                ...
                .Add<PowderCoatingWizardWinModule>();
            ...
            builder.Security
                ...
                .AddExternalAuthentication<PowderCoatingWizard.Module.CustomAuthenticationProvider>()
                    .AddAzureAD(opt =>
                    {
